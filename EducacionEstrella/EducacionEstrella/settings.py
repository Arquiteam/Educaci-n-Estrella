...
SECRET_KEY = 'django-insecure-xu9y^*96_mlh&bz48c(vwe1y+90*&i9zt%yvmsr+w$l+=-y(ac'
...
INSTALLED_APPS = [
    ...
    'SucursalAcompañamiento.apps.SucursalacompañamientoConfig',
    'ServicioAtencionPsicologica.apps.ServicioatencionpsicologicaConfig',
    'ServicioBolsaEmpleo.apps.ServiciobolsaempleoConfig',
